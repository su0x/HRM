...
<form name="frm" method="post" action="<%=request.getContextPath() %>/CWModifyAction">
	<table  class="table table-bordered">
				...
				<tr class=" info">    <td><span>部门类型</span></td> <td><input name="depttype" value="<%=dept.getDepttype() %>"></td><td ><span>部门地址</span></td> <td><input name="location" value="<%=dept.getLocation() %>"></td> <td></td><td></td> 																</tr>
